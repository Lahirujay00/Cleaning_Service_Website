...
const GutterCleaning = () => {
    ...
    const servicesData = [
        {
            image: gutterCleaningImage1,
            title: "Removal of leaves, dirt, and debris",
            description: "Thorough cleaning and removal of all accumulated leaves, dirt, and debris from your gutters to ensure clear water flow."
        },
        {
            image: gutterCleaningImage2,
            title: "Downpipe flushing (where required)",
            description: "Ensuring all downpipes are clear and free of blockages, allowing rainwater to drain effectively away from your property."
        },
        {
            image: gutterCleaningImage3,
            title: "Inspection for blockages or damage",
            description: "A detailed inspection of your gutter system for any signs of blockages, leaks, or damage that may require attention."
        },
        {
            image: gutterCleaningImage4,
            title: "Clean-up of debris from surrounding areas",
            description: "We don't just clean your gutters; we also ensure all surrounding areas are free from debris after the service."
        },
        {
            image: gutterCleaningImage5,
            title: "Preventative Maintenance",
            description: "Recommendations for gutter guards or regular maintenance schedules to prevent future issues."
        },
        {
            image: gutterCleaningImage6,
            title: "Water Flow Testing",
            description: "Testing the flow of water through your cleaned gutters and downpipes to ensure optimal performance."
        }
    ];
    ...
    const idealForData = [
        {
            ...
            title: "Homes, townhouses, and commercial properties",
            description: "Our service is ideal for various property types, ensuring clean gutters for all.",
            color: "#2CA2B0"
        },
        {
            icon: (
                <svg className="w-24 h-24" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {/* Shield with Water Drop */}
                    <path d="M48 16L20 32V64C20 74.6667 28 80 48 80C68 80 76 74.6667 76 64V32L48 16Z" fill="#E6F7FF" stroke="#2CA2B0" strokeWidth="2"/>
                    <path d="M48 30V60M48 60C48 68 56 68 56 60C56 52 48 52 48 44" stroke="#2CA2B0" strokeWidth="2"/>
                </svg>
            ),
            title: "Preventing water damage and roof issues",
            description: "Crucial for safeguarding your property against costly water-related damages.",
            color: "#0A3D62"
        },
        {
            icon: (
                <svg className="w-24 h-24" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {/* Leaf and Calendar */}
                    <path d="M48 16C48 16 36 24 36 36C36 48 48 56 48 56C48 56 60 48 60 36C60 24 48 16 48 16Z" fill="#E6F7FF" stroke="#2CA2B0" strokeWidth="2"/>
                    <path d="M48 56L40 64L48 72L56 64L48 56Z" fill="#2CA2B0"/>
                    <rect x="20" y="20" width="56" height="56" rx="4" stroke="#2CA2B0" strokeWidth="2"/>
                    <path d="M20 30h56" stroke="#2CA2B0" strokeWidth="2"/>
                </svg>
            ),
            title: "Seasonal or yearly maintenance",
            description: "Essential for proactive home care, especially during heavy leaf fall or rainy seasons.",
            color: "#2CA2B0"
        }
    ];
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <section className="relative min-h-screen bg-gradient-to-br from-[#F8FAFC] via-[#E2E8F0] to-[#CBD5E1]">
                {/* Background Pattern */}
                <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-5"></div>
                ...
                <div className="relative container mx-auto px-4 h-screen flex items-center">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            >
                                Our comprehensive gutter cleaning services ensure proper water flow, 
                                preventing costly damage to your home's foundation and roof.
                            </motion.p>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                            ...
                            <span className="text-cyan">Gutter Cleaning</span>
                        </h2>
                        <p className="text-xl text-gray-600 leading-relaxed">
                            Comprehensive gutter cleaning services designed to protect your home and prevent water damage.
                        </p>
                    </motion.div>
            ...
            <section className="py-20 bg-[#F0F9FF]">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        >
                            Our Gutter Cleaning Service Is <span className="text-cyan">Ideal For</span>
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                        ...
                        >
                            Tailored solutions to meet the specific needs of various properties and situations.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-gray-700">
                                At the heart of our service is a commitment to excellence. Our cleaning professionals undergo rigorous training in the latest techniques, safety protocols, and customer service standards. Each team member is carefully vetted and certified to ensure your gutters receive the highest quality care.
                            </p>
                            
                            <p className="text-gray-700 my-4">
                                We follow a systematic approach to cleaning, using a detailed checklist customized for each property. This ensures consistent quality and attention to detail, from initial assessment to final clean-up.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-8">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        title: "Safety First",
                                        desc: "Adherence to safety protocols"
                                    },
                                    {
                                ...
                                {[
                                    {
                                        ...
                                        description: "Thorough evaluation of your gutter system's specific cleaning needs and requirements."
                                    },
                                    {
                                        title: "Custom Cleaning Plan",
                                        description: "Development of a tailored cleaning strategy based on your property's specific needs."
                                    },
                                    {
                                        title: "Professional Execution",
                                        description: "Systematic cleaning following our detailed area-by-area checklist for gutters."
                                    },
                                    {
                                        title: "Quality Inspection",
                                        description: "Final walkthrough to ensure everything meets our high standards and water flows freely."
                                    }
                                ].map((process, index) => (
                                    <motion.div 
                                        key={index}
            ...
            <section id="contact-us" className="py-24 bg-gradient-to-br from-white to-cyan/5 relative overflow-hidden">
                {/* Background Pattern */}
                <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-5"></div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <div className="inline-flex items-center space-x-2 bg-cyan/10 px-4 py-2 rounded-full">
                                    ...
                                    <span className="text-sm font-medium text-cyan">Trusted Gutter Cleaning Professionals</span>
                                </div>
                                ...
                                <p className="text-xl text-gray-600 leading-relaxed">
                                    Contact us today for a customized quote and experience the peace of mind that comes with properly maintained gutters.
                                </p>
                                ...
                                <div className="relative space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 mb-8">
                                        ...
                                        <p className="text-gray-600 italic mb-4">
                                            "SparkWise Cleaning did an amazing job with our gutters! Professional, efficient, and they left the area spotless."
                                        </p>
